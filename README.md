...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Zanoshky/macbook-pro-setup/main/setup-mac.sh)
```

### Dry Run (preview without installing)

```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Zanoshky/macbook-pro-setup/main/setup-mac.sh) --dry-run
```

### No Color

```bash
NO_COLOR=1 bash <(curl -fsSL https://raw.githubusercontent.com/Zanoshky/macbook-pro-setup/main/setup-mac.sh)
```
